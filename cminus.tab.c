...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_37_2 = 37,                      /* $@2  */
  YYSYMBOL_38_3 = 38,                      /* $@3  */
  YYSYMBOL_tipo_espec = 39                 /* tipo_espec  */
};
...
{
      -5,   -24,   -24,     2,    -5,   -24,   -24,    -4,   -24,   -24,
     -21,   -23,   -18,   -24,    -2,   -24,   -17,   -19,   -24
};
...
{
     -24,   -24,   -24,     6,   -24,   -24,   -24,   -24,   -24
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     3,     4,     5,     6,    11,    12,    16,     7
};
...
{
       1,     2,     8,    -8,    10,    13,    14,    15,    17,    18,
       9
};

static const yytype_int8 yycheck[] =
{
       5,     6,     0,    24,     8,    28,    24,     9,    25,    28,
       4
};
...
{
       0,     5,     6,    32,    33,    34,    35,    39,     0,    34,
       8,    36,    37,    28,    24,     9,    38,    25,    28
};

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
static const yytype_int8 yyr1[] =
{
       0,    31,    32,    33,    33,    34,    36,    35,    37,    38,
      35,    39,    39
};
...
#line 1129 "cminus.tab.c"
    break;

  case 4: /* decl_lista: decl  */
#line 45 "cminus.y"
                    { yyval = yyvsp[0]; }
#line 1135 "cminus.tab.c"
    break;

  case 5: /* decl: var_decl  */
#line 47 "cminus.y"
                       { yyval = yyvsp[0]; }
#line 1141 "cminus.tab.c"
    break;
...
#line 50 "cminus.y"
                            { savedName = copyString(tokenString);
                              savedLineNo = lineno; }
#line 1148 "cminus.tab.c"
    break;

  case 7: /* var_decl: tipo_espec ID $@1 SEMI  */
#line 53 "cminus.y"
                { yyval = newTypeNode();
...
#line 61 "cminus.y"
                            { savedName = copyString(tokenString);
                              savedLineNo = lineno; }
#line 1168 "cminus.tab.c"
    break;

  case 9: /* $@3: %empty  */
#line 63 "cminus.y"
                         { savedValue = atoi(tokenString); }
#line 1174 "cminus.tab.c"
    break;

  case 10: /* var_decl: tipo_espec ID $@2 LBRACK NUM $@3 RBRACK SEMI  */
#line 64 "cminus.y"
                {
                  yyval = newTypeNode();
                  yyval = yyval->child[0];
...
#line 1190 "cminus.tab.c"
    break;

  case 11: /* tipo_espec: INT  */
#line 77 "cminus.y"
              {yyval = NULL;}
#line 1196 "cminus.tab.c"
    break;

  case 12: /* tipo_espec: VOID  */
#line 79 "cminus.y"
              {yyval = NULL;}
#line 1202 "cminus.tab.c"
    break;
